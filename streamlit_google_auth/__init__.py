...
# https://github.com/MrBounty/streamlit-google-auth/tree/main
import os
import time
...
class Authenticate:
    ...
    def login(self, color:Literal['white', 'blue']='blue', justify_content: str="center") -> tuple:
        if not st.session_state['connected']:
            ...
            # Store the code_verifier generated by oauthlib in the session state
            st.session_state["code_verifier"] = getattr(flow, "code_verifier", getattr(flow.oauth2session, "code_verifier", None))
        ...
        if not st.session_state['connected']:
            ...
            if not st.session_state['connected']:
                ...
                if auth_code:
                    ...
                    # Retrieve the code_verifier from the session state
